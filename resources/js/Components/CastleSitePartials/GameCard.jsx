...
function GameCard({game,game_id,allFetchedData,competition_id,region_id,sport_id}) {
    ...
    const competition_name=allFetchedData[sport_id].region[region_id].competition[competition_id].name;
