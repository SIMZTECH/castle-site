...
function TransactionCard({dept,trans_id,operation_name,bet_id,time_stamp, bal, amount }) {
    ...
    return (
        <div className="flex flex-col font-poppins text-[12px] mx-4 cursor-pointer sm:hover:bg-transparent hover:bg-gray-200 text-[#27393f] gap-1 bg-opacity-20 bg-white sm:rounded-none sm:bg-transparent sm:bgorder-b-[1px] sm:border-dotted sm:border-r-0 sm:border-l-0 sm:border-t-0 p-2 rounded-md border-b-[1px] border-gray-300 bg-clip-padding">
