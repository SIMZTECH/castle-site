...
export default function Authenticated({auth, header, children }) {
    ...
    const [userRoles,setUserRoles] = useState(auth.user.roles);
     ...
     * @returns bool
     */
    const rolesFinderHandler=(arg)=>{
        const isfound = userRoles.find((val)=>val?.name==arg);
        return isfound; 
    }
