...
function HighLightGameCardDashboardDefault({fetchedGameData,competition_name,sport_name,region_name,game_id,competition_id,region_id}) {
  ...
  return (
    <div className="flex flex-col pt-4 mb-3 space-y-1 font-poppins">
          <div className='flex items-center justify-between h-[40px] leading-5'>
              ...
              <div className="flex items-center gap-1">
                  <div className="flex flex-col items-end text-[12px]">
                      ...
                      <p className='text-white text-opacity-60'>{formattedDate}</p>
                  </div>
                  <button
                    onClick={()=>route(routeConstruct())} 
                    className=' bg-primaryColor active:scale-95 text-white outline-none bg-opacity-30 h-[35px] rounded-sm px-1'>
                      <TfiAngleRight />
                  </button>
              </div>
          </div>
          ...
          <div className="flex items-center justify-between">
              ...
              <Link
                  to={routeConstruct()}
                  className="text-[10px] cursor-pointer hover:underline hover:text-opacity-100 font-poppins text-mediumYellowColor"
              >
...
export default HighLightGameCardDashboardDefault
